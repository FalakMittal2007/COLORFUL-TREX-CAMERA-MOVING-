...
function preload(){
  ...
  backgroundImg = loadImage("cartoon-desert-banner.jpg")
  sunAnimation = loadImage("unnamed.png");
  
  trex_running = loadImage("AgonizingClumsyGermanshorthairedpointer-max-1mb.gif");
  trex_collided = loadImage("AgonizingClumsyGermanshorthairedpointer-max-1mb.gif");
...
function setup() {
  ...
  sun = createSprite(width-350,100,10,10);
